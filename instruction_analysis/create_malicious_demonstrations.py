...
#     type=str,
#     required=True,
#     help="prefix of the ids in the ouptut file",
# )
...
if __name__ == "__main__":
    ...
    name = args.name or "instruction_demonstration"
    ...
    dataset.to_json(f"{args.persistent_dir}/results/{name}/{experiment_id}/malicious_for_unique_instructions.jsonl")
